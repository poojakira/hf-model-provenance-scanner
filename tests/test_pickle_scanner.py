...
class TestPickleMaliciousDetection(unittest.TestCase):
    def test_os_system_call(self):
        ...
        self.assertIn("HFS-050", rule_ids, "Should detect os.system as critical callable")
    ...
    def test_subprocess_call(self):
        ...
        rule_ids = [f.rule_id for f in findings]
        self.assertIn(
            "HFS-050", rule_ids, "Should detect subprocess.check_output as critical callable"
        )
    ...
    def test_eval_call(self):
        ...
        findings = scan_pickle_bytes("malicious.pkl", data)
        rule_ids = [f.rule_id for f in findings]
        self.assertIn("HFS-050", rule_ids, "Should detect builtins.eval as critical callable")
    ...
    def test_stack_global_bypass(self):
        ...
        findings = scan_pickle_bytes("malicious.pkl", data)
        rule_ids = [f.rule_id for f in findings]
        self.assertIn("HFS-050", rule_ids, "Should detect os.system via STACK_GLOBAL opcode")
    ...
    def test_corrupted_pickle_with_globals(self):
        ...
        self.assertTrue(has_detection, "Should detect dangerous content in corrupted pickle")
...
class TestPickleSafeAllowlist(unittest.TestCase):
    def test_safe_torch_model(self):
        ...
        self.assertEqual(len(critical), 0, "Legitimate torch patterns should not trigger HFS-050")
