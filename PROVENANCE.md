...
Three historical commits used a legacy account identity for Pooja Kiran / @poojakira:
...
Those commits are canonicalized to **Pooja Kiran / @poojakira** through `.mailmap`. The original commit objects remain intact so dates and file history stay auditable.
